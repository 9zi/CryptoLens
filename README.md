...
> **Academic Compliance Note:** The raw source code for this project is withheld from public viewing to strictly comply with The University of Manchester's academic integrity policies regarding graded coursework. Below is a comprehensive overview of the system architecture, the technologies implemented, and the outcomes achieved.
...
Set Up On Another Machine
    ...
    Install dependencies and optionally set GROQ_API_KEY in .env.
...
This project covers:
    ...
    Machine learning (LinearRegression for time series)

    NLP / Sentiment analysis (TextBlob + custom lexicon)

    AI integration (Groq API, prompt hardening)
